...
//#include "src/numeric_bit/sc_nbdefs.h"
//#include "src/numeric_bit/sc_nbutils.h"
//#include "src/numeric_bit/sc_nbexterns.h"
#include "sc_nbdefs.h"
...
private:
  ...
  sc_unsigned_bitref(sc_unsigned* u, length_type i) { snum = u; index = i; }
...
private:
  ...
  sc_unsigned_subref(sc_unsigned* u, length_type l, length_type r)
...
public:
  ...
  */
  ...
  // Helper functions.
  friend length_type compare_unsigned(small_type us, 
                                      length_type unb,
                                      length_type und, 
                                      const digit_type *ud, 
                                      small_type vs, 
...
private:
  ...
  sc_unsigned(small_type s, length_type nb, length_type nd, 
              digit_type *d, bool alloc = true);

  // Create an unsigned number using the bits u[l..r].
  sc_unsigned(const sc_unsigned* u, length_type l, length_type r);
  ...
  length_type num_bits(length_type nb) const { return nb + 1; }
