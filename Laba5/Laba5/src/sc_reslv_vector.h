...
public:
    ...
    explicit sc_signal_resolved_vector( const char* nm, int len );
...
extern signal_rlv& operator,( signal_rlv&, signal_rlv& );
extern signal_rlv& operator,( signal_rlv&, sc_signal_resolved& );
extern signal_rlv& operator,( sc_signal_resolved&, signal_rlv& );

extern const signal_rlv& operator,( const signal_rlv&, const signal_rlv& );
extern const signal_rlv& operator,( const signal_rlv&, const sc_signal_resolved& );
