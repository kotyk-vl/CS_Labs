...
/******************************************************************************
    ...
    main -- 
    Purpose  : This is a simple CPU modeling using SystemC.
...
/**********************************************************************/
/* 		Main file for CPU simulation 			      */
//  		Designer : Martin Wang
/**********************************************************************/
...
int sc_main(int ac, char *av[])
{
  ...
  printf("//             \n");
  printf("/////////////////////////////////////////////////////////////////////////\n");
  cout << "// IN THIS MACHINE Interger is " << sizeof (int) << " bytes.\n";
  ...
  sc_start(clk, -1);
  cout << "Time for simulation = " << (double)(clock() - tbuffer) / (double)CLOCKS_PER_SEC << endl;
  getchar();
  cout << endl;
