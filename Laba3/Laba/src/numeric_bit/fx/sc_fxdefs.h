...
#ifndef   SC_UTILS_H
#include "numeric_bit/sc_nbutils.h"
#endif
...
// ----------------------------------------------------------------------------
//  MACRO : ENUM_CLASS(name)
//
//  Type definition macro for enum like type, but stronger typed.
// ----------------------------------------------------------------------------
...
public:                                                                       \
    ...
    const sc_string to_string() const;                                        \
                                                                              \
    friend ostream& operator << ( ostream& os, const name& a )                \
