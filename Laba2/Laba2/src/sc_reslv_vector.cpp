...
{
    return DCAST(sc_signal_resolved_vector&, sc_array_base::sub(i,j));
}
...
signal_rlv&
operator,( signal_rlv& x, signal_rlv& y )
{
    return *(signal_rlv::get_concat_array( &x, &y ));
}

signal_rlv&
operator,( signal_rlv& x, sc_signal_resolved& y )
{
    return *(signal_rlv::get_concat_array( &x, &y ));
}
...
const signal_rlv&
operator,( const signal_rlv& x, const signal_rlv& y )
{
    return *(signal_rlv::get_concat_array( (signal_rlv*) &x, (signal_rlv*) &y ));
}

const signal_rlv&
operator,( const signal_rlv& x, const sc_signal_resolved& y )
{
    return *(signal_rlv::get_concat_array( (signal_rlv*) &x, (sc_signal_resolved*) &y ));
}
