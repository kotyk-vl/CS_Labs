...
class sc_bool_vector : public sc_array<bool> {
    ...
    friend const sc_bool_vector& operator,( const sc_bool_vector&, const char* );
    friend const sc_bool_vector& operator,( const char*, const sc_bool_vector& );
...
extern sc_bool_vector& operator,( sc_bool_vector&, sc_bool_vector& );
extern sc_bool_vector& operator,( sc_bool_vector&, bool& );
extern sc_bool_vector& operator,( bool&, sc_bool_vector& );
extern const sc_bool_vector& operator,( const sc_bool_vector&, const char* );
extern const sc_bool_vector& operator,( const char*, const sc_bool_vector& );

extern const sc_bool_vector& operator,( const sc_bool_vector&, const sc_signal_bool_vector& );
extern const sc_bool_vector& operator,( const sc_signal_bool_vector&, const sc_bool_vector& );

extern const sc_bool_vector& operator,( const sc_bool_vector&, const sc_bool_vector& );
extern const sc_bool_vector& operator,( const sc_bool_vector&, const bool& );
extern const sc_bool_vector& operator,( const bool&, const sc_bool_vector& );
extern const sc_bool_vector& operator,( const sc_bool_vector&, const sc_signal<bool>& );
...
extern sc_signal_bool_vector& operator,( sc_signal_bool_vector&, sc_signal_bool_vector& );
extern sc_signal_bool_vector& operator,( sc_signal_bool_vector&, sc_signal<bool>& );
extern sc_signal_bool_vector& operator,( sc_signal<bool>&, sc_signal_bool_vector& );

extern const sc_signal_bool_vector& operator,( const sc_signal_bool_vector&, const sc_signal_bool_vector& );
extern const sc_signal_bool_vector& operator,( const sc_signal_bool_vector&, const sc_signal<bool>& );
...
#include "sc_bool_vector_defs.h_"
