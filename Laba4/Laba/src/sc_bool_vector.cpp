...
{
    return DCAST(sc_bool_vector&, sc_array_base::sub(i,j));
}
...
#include "sc_bool_vector_and.cpp"
#include "sc_bool_vector_or.cpp"
#include "sc_bool_vector_xor.cpp"
...
sc_bool_vector::to_signed() const
{
    ...
    if ((unsigned)len > sizeof(int)*8) {
        cout << "sc_bool_vector::to_signed(): " << endl;
        cout << "    warning: vector is wider than int" << endl;
        cout << "             value may be truncated" << endl;
        v = 0;
...
sc_bool_vector::to_unsigned() const
{
    ...
    if ((unsigned) len > sizeof(unsigned)*8) {
        cout << "sc_bool_vector::to_unsigned():" << endl;
        cout << "    warning: vector is wider than unsigned" <<endl;
        cout << "    value may be truncated" << endl;
...
{
    return DCAST(sc_signal_bool_vector&, sc_array_base::sub(i,j));
}
...
sc_bool_vector&
operator,( sc_bool_vector& x, sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( &x, &y ));
}

sc_bool_vector&
operator,( sc_bool_vector& x, bool& y )
{
    return *(sc_bool_vector::get_concat_array( &x, &y ));
}

sc_bool_vector&
operator,( bool& x, sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( &x, &y ));
}

const sc_bool_vector&
operator,( const sc_bool_vector& x, const char* y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, y ));
}

const sc_bool_vector&
operator,( const char* x, const sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( x, (sc_bool_vector*) &y ));
}

const sc_bool_vector&
operator,( const sc_bool_vector& x, const sc_signal_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, (sc_bool_vector*) &y ));
}

const sc_bool_vector&
operator,( const sc_signal_bool_vector& x, const sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, (sc_bool_vector*) &y ));
}

const sc_bool_vector&
operator,( const sc_bool_vector& x, const sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, (sc_bool_vector*) &y ));
}

const sc_bool_vector&
operator,( const sc_bool_vector& x, const bool& y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, (bool*) &y ));
}

const sc_bool_vector&
operator,( const bool& x, const sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( (bool*) &x, (sc_bool_vector*) &y ));
}

const sc_bool_vector&
operator,( const sc_bool_vector& x, const sc_signal<bool>& y )
{
    return *(sc_bool_vector::get_concat_array( (sc_bool_vector*) &x, (bool*) y.get_data_ptr() ));
}

const sc_bool_vector&
operator,( const sc_signal<bool>& x, const sc_bool_vector& y )
{
    return *(sc_bool_vector::get_concat_array( (bool*) x.get_data_ptr(), (sc_bool_vector*) &y ));
}
...
sc_signal_bool_vector&
operator,( sc_signal_bool_vector& x, sc_signal_bool_vector& y )
{
    return *(sc_signal_bool_vector::get_concat_array( &x, &y ));
}

sc_signal_bool_vector&
operator,( sc_signal_bool_vector& x, sc_signal<bool>& y )
{
    return *(sc_signal_bool_vector::get_concat_array( &x, &y ));
}
...
operator,( const sc_signal_bool_vector& x, const sc_signal_bool_vector& y )
{
    return *(sc_signal_bool_vector::get_concat_array( (sc_signal_bool_vector*) &x, (sc_signal_bool_vector*) &y ));
}

const sc_signal_bool_vector&
operator,( const sc_signal_bool_vector& x, const sc_signal<bool>& y )
{
    return *(sc_signal_bool_vector::get_concat_array( (sc_signal_bool_vector*) &x, (sc_signal<bool>*) &y ));
}
