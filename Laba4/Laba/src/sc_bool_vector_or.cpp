 ...
 *
 *  _define_ | to           &           |           ^ 
 *  _define_ or_reduce to    and_reduce  or_reduce   xor_reduce
 *  _define_ false to     true        false       false
 *  _define_ or  to     and         or          xor
 */
...
bool
sc_bool_vector::or_reduce () const
{
    bool result = false;
...
sc_signal_bool_vector::write( const sc_bool_vector_orop1& x )
{
...
sc_signal_bool_vector&
sc_signal_bool_vector::write( const sc_bool_vector_orop2& x )
{
    const sc_bool_vector* a = x.a;
    const char* b = x.b;
    int leng = length();
