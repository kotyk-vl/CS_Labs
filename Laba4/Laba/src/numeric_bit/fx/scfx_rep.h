...
public:
    ...
    friend scfx_rep*   negate( const scfx_rep& );
    friend scfx_rep* multiply( const scfx_rep&, const scfx_rep&,
			       int = _SC_DEFAULT_MAX_WL );
    friend scfx_rep*   divide( const scfx_rep&, const scfx_rep&,
			       int = _SC_DEFAULT_DIV_WL );
    friend scfx_rep*      add( const scfx_rep&, const scfx_rep&,
			       int = _SC_DEFAULT_MAX_WL );
    friend scfx_rep* subtract( const scfx_rep&, const scfx_rep&,
			       int = _SC_DEFAULT_MAX_WL );
    friend scfx_rep*   lshift( const scfx_rep&, int );
    friend scfx_rep*   rshift( const scfx_rep&, int );

    void lshift( int );
    void rshift( int );

    friend scfx_rep* b_not( const scfx_rep&,
			    const scfx_params& );
    friend scfx_rep* b_and( const scfx_rep&, const scfx_rep&,
			    const scfx_params& );
    friend scfx_rep* b_xor( const scfx_rep&, const scfx_rep&,
			    const scfx_params& );
    friend scfx_rep*  b_or( const scfx_rep&, const scfx_rep&,
			    const scfx_params& );

    friend int   compare( const scfx_rep&, const scfx_rep& );
    ...
    friend scfx_rep* quantization( const scfx_rep&, const scfx_params&,
				   bool& );
    friend scfx_rep*     overflow( const scfx_rep&, const scfx_params&,
				   bool& );
...
inline
scfx_rep::scfx_rep( unsigned int i )
: _mant( min_mant ), _r_flag( false )
{
    if( i )
    {
...
inline
scfx_rep::scfx_rep( unsigned long i )
: _mant( min_mant ), _r_flag( false )
{
    if( i )
    {
...
inline
scfx_rep::scfx_rep( const scfx_rep& f )
: _mant(f._mant), _wp(f._wp), _sign(f._sign), _state(f._state),
  _msw(f._msw), _lsw(f._lsw), _r_flag( false )
{}
...
inline
scfx_rep*
multiply( const scfx_rep& a, const scfx_rep& b, int max_wl )
{
...
inline
scfx_rep*
quantization( const scfx_rep& a, const scfx_params& params, bool& q_flag )
{
    scfx_rep& c = *new scfx_rep( a );
...
inline
scfx_rep*
overflow( const scfx_rep& a, const scfx_params& params, bool& o_flag )
{
    scfx_rep& c = *new scfx_rep( a );
